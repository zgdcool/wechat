...
import dlintech.com.tools.GdHttpUtils;
import dlintech.com.tools.security.GdMD5;
...
public class GdRequestHandler {
     ...
     * @return
     */
    public GdRequestHandler(HttpServletRequest request, HttpServletResponse response) {
        this.last_errcode = "0";
        // this.charset = "GBK";
        this.charset = "UTF-8";
    ...
    public String createSign(SortedMap<String, String> packageParams) {
        ...
        String sign = GdMD5.MD5Encode(sb.toString(), this.charset)
                .toUpperCase();
    ...
    public boolean checkSign(Map<String, String> resultMap) {
        if (resultMap == null) {
            return false;
        }
        String signValue = createSign(new TreeMap<String, String>(resultMap));
        String sign = resultMap.get("sign");
        return StringUtils.equalsIgnoreCase(signValue, sign);
    ...
    public boolean createMd5Sign(String signParams) {
        ...
        // 算出摘要
        String enc = GdHttpUtils.getCharacterEncoding(this.request,
                this.response);
        String sign = GdMD5.MD5Encode(sb.toString(), enc).toLowerCase();
